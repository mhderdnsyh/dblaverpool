...
var app = new Vue({
  ...
  methods: {
    ...
    saveMember: function () {
      ...
      axios.post("api.php?crud=create", memForm).then(function (response) {
        //console.log(response);
    ...
    updateMember() {
      ...
      axios.post("api.php?crud=update", memForm).then(function (response) {
        //console.log(response);
        app.clickMember = {};
        if (response.data.error) {
          app.errorMessage = response.data.message;
    ...
    deleteMember() {
      var memForm = app.toFormData(app.clickMember);
      axios.post("api.php?crud=delete", memForm).then(function (response) {
        //console.log(response);
        app.clickMember = {};
        if (response.data.error) {
          app.errorMessage = response.data.message;
